...
# Load bbone
model1 = onnx.load('modules/hpe/modules/onnxs/bbone1.onnx')
# model1 = version_converter.convert_version(model1, 7)
...
model2 = onnx.load('modules/hpe/modules/onnxs/heads1.onnx')


# model2 = version_converter.convert_version(model2, 6)


combined_model = onnx.compose.merge_models(
    model1, model2,
    io_map=[('prediction', 'input')]
)
